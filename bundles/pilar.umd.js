(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/common/http'), require('@angular/forms'), require('@angular/router'), require('ngx-contextmenu'), require('ngx-lazy-load-images'), require('ngx-bootstrap'), require('ngx-select-ex'), require('rxjs'), require('ngx-bootstrap/modal'), require('@angular/animations'), require('@angular/platform-browser'), require('@tinymce/tinymce-angular')) :
    typeof define === 'function' && define.amd ? define('pilar', ['exports', '@angular/core', '@angular/common', '@angular/common/http', '@angular/forms', '@angular/router', 'ngx-contextmenu', 'ngx-lazy-load-images', 'ngx-bootstrap', 'ngx-select-ex', 'rxjs', 'ngx-bootstrap/modal', '@angular/animations', '@angular/platform-browser', '@tinymce/tinymce-angular'], factory) :
    (global = global || self, factory(global.pilar = {}, global.ng.core, global.ng.common, global.ng.common.http, global.ng.forms, global.ng.router, global.ngxContextmenu, global.ngxLazyLoadImages, global.ngxBootstrap, global.ngxSelectEx, global.rxjs, global.modal, global.ng.animations, global.ng.platformBrowser, global.tinymceAngular));
}(this, (function (exports, core, common, http, forms, router, ngxContextmenu, ngxLazyLoadImages, ngxBootstrap, ngxSelectEx, rxjs, modal, animations, platformBrowser, tinymceAngular) { 'use strict';
    ...
    var PilarService = /** @class */ (function () {
        ...
        /** @nocollapse */ PilarService.ngInjectableDef = core.defineInjectable({ factory: function PilarService_Factory() { return new PilarService(); }, token: PilarService, providedIn: "root" });
        return PilarService;
    }());
    ...
    // translation token
    /** @type {?} */
    var TRANSLATIONS = new core.InjectionToken('translations');
    // all traslations
    ...
    var AccordionService = /** @class */ (function () {
        ...
        /** @nocollapse */ AccordionService.ngInjectableDef = core.defineInjectable({ factory: function AccordionService_Factory() { return new AccordionService(); }, token: AccordionService, providedIn: "root" });
    ...
    var AccordionComponent = /** @class */ (function () {
        ...
        AccordionComponent.propDecorators = {
            isAnimated: [{ type: core.Input, args: ['isAnimated',] }],
            closeOthers: [{ type: core.Input, args: ['closeOthers',] }]
        };
    ...
    var AccordionGroupComponent = /** @class */ (function () {
        ...
        AccordionGroupComponent.propDecorators = {
            isOpen: [{ type: core.Input, args: ['isOpen',] }],
            heading: [{ type: core.Input, args: ['heading',] }],
            isDisabled: [{ type: core.Input, args: ['isDisabled',] }],
            panelClass: [{ type: core.Input, args: ['panelClass',] }],
            isOpenChange: [{ type: core.Output, args: ['isOpenChange',] }],
            panelColor: [{ type: core.Input, args: ['panelColor',] }]
        };
    ...
    var TablePageService = /** @class */ (function () {
        function TablePageService() {
            this.page = new rxjs.BehaviorSubject({});
        }
        /**
         * @param {?} page
         * @return {?}
        ...
        /** @nocollapse */ TablePageService.ngInjectableDef = core.defineInjectable({ factory: function TablePageService_Factory() { return new TablePageService(); }, token: TablePageService, providedIn: "root" });
    ...
    var ClientTableComponent = /** @class */ (function () {
        function ClientTableComponent(_tablePageSvc) {
            ...
            this.deleteClicked = new core.EventEmitter();
            this.detailClicked = new core.EventEmitter();
            this.inValidateClicked = new core.EventEmitter();
            this.pageChanged = new core.EventEmitter();
            this.printClicked = new core.EventEmitter();
            this.publishClicked = new core.EventEmitter();
            this.radioSelect = new core.EventEmitter();
            this.reloadClicked = new core.EventEmitter();
            this.selectedRows = new core.EventEmitter();
            this.switchChanged = new core.EventEmitter();
            this.validateClicked = new core.EventEmitter();
            this.verifyClicked = new core.EventEmitter();
            this.limitChanged = new core.EventEmitter();
            this.inputTextValueChange = new core.EventEmitter();
            this.inputRadioValueChange = new core.EventEmitter();
            this.page = new PilTablePage();
        ...
        ClientTableComponent.propDecorators = {
            actionColumn: [{ type: core.Input }],
            actionTitle: [{ type: core.Input }],
            actionInValidation: [{ type: core.Input }],
            checkboxColumn: [{ type: core.Input }],
            footerInfo: [{ type: core.Input }],
            footerOptions: [{ type: core.Input }],
            limitOptions: [{ type: core.Input }],
            paginationOptions: [{ type: core.Input }],
            radioColumn: [{ type: core.Input }],
            searchOptions: [{ type: core.Input }],
            columns: [{ type: core.Input }],
            rows: [{ type: core.Input }],
            editClicked: [{ type: core.Output }],
            deleteClicked: [{ type: core.Output }],
            detailClicked: [{ type: core.Output }],
            inValidateClicked: [{ type: core.Output }],
            pageChanged: [{ type: core.Output }],
            printClicked: [{ type: core.Output }],
            publishClicked: [{ type: core.Output }],
            radioSelect: [{ type: core.Output }],
            reloadClicked: [{ type: core.Output }],
            selectedRows: [{ type: core.Output }],
            switchChanged: [{ type: core.Output }],
            validateClicked: [{ type: core.Output }],
            verifyClicked: [{ type: core.Output }],
            limitChanged: [{ type: core.Output }],
            inputTextValueChange: [{ type: core.Output }],
            inputRadioValueChange: [{ type: core.Output }]
        };
    ...
    var FileUploadComponent = /** @class */ (function () {
        function FileUploadComponent() {
            ...
            this.filesSelected = new core.EventEmitter();
            this.files = [];
            this.sizes = [];
    ...
    var MobileFilterComponent = /** @class */ (function () {
        function MobileFilterComponent() {
            ...
            this.limitChanged = new core.EventEmitter();
            this.allRowsOnMobileSelected = new core.EventEmitter();
        ...
        MobileFilterComponent.propDecorators = {
            ...
            limitOptions: [{ type: core.Input }],
            searchOptions: [{ type: core.Input }],
            isAllRowsSelected: [{ type: core.Input }],
            limitChanged: [{ type: core.Output }],
            allRowsOnMobileSelected: [{ type: core.Output }],
    ...
    var PaginationComponent = /** @class */ (function () {
        ...
        PaginationComponent.propDecorators = {
            dataPerPage: [{ type: core.Input }],
            amountOfData: [{ type: core.Input }],
    ...
    var ServerTableComponent = /** @class */ (function () {
        function ServerTableComponent(_tablePageSvc) {
            ...
            this.printClicked = new core.EventEmitter();
            this.publishClicked = new core.EventEmitter();
            this.radioChanged = new core.EventEmitter();
            this.reloadClicked = new core.EventEmitter();
            this.selectedRows = new core.EventEmitter();
            this.switchChanged = new core.EventEmitter();
            this.validateClicked = new core.EventEmitter();
    ...
    var TableActionComponent = /** @class */ (function () {
        function TableActionComponent() {
            this.emitAction = new core.EventEmitter();
        }
        ...
        TableActionComponent.propDecorators = {
            ...
            auth: [{ type: core.Input }],
            index: [{ type: core.Input }],
            emitAction: [{ type: core.Output }]
        };
    ...
    var TableFooterComponent = /** @class */ (function () {
        ...
        TableFooterComponent.propDecorators = {
            ...
            startPage: [{ type: core.Input }],
            endPage: [{ type: core.Input }]
        };
        ...
        TableSkeletonComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        animations: [
                            ...
                            animations.trigger('fadeOut', fadeOut())
                        ]
                    }] }
        ];
        TableSkeletonComponent.propDecorators = {
            customElement: [{ type: core.Input }],
            columnCount: [{ type: core.Input }],
            rowCount: [{ type: core.Input }],
            showActionColumn: [{ type: core.Input }],
            showButtonCreate: [{ type: core.Input }],
            showCheckButton: [{ type: core.Input }],
            showLimitOptions: [{ type: core.Input }],
            showMobileLimitOptions: [{ type: core.Input }],
            showNumberColumn: [{ type: core.Input }],
            showRadioButton: [{ type: core.Input }],
            showSearchOptions: [{ type: core.Input }],
            useCustomElement: [{ type: core.Input }]
        };
    ...
    var TextEditorComponent = /** @class */ (function () {
        function TextEditorComponent() {
            ...
            this.toolBar = true;
            this.statusBar = true;
            this.editorContentChanged = new core.EventEmitter();
            this.editorBlured = new core.EventEmitter();
            this.tinyMceConfig = {
        ...
        TextEditorComponent.propDecorators = {
            ...
            menuBar: [{ type: core.Input }],
            toolBar: [{ type: core.Input }],
            statusBar: [{ type: core.Input }],
            editorContentChanged: [{ type: core.Output }],
            editorBlured: [{ type: core.Output }]
        };
    ...
    var UiiImageUploadComponent = /** @class */ (function () {
        function UiiImageUploadComponent(imageSvc) {
            ...
            this.required = false;
            this.fileType = ['png'];
            this.imageSelected = new core.EventEmitter();
        ...
        UiiImageUploadComponent.propDecorators = {
            ...
            imageSelected: [{ type: core.Output }]
        };
    ...
    var UiiDataGridComponent = /** @class */ (function () {
        ...
        UiiDataGridComponent.propDecorators = {
            gridTitle: [{ type: core.Input }],
            columnTitle: [{ type: core.Input }],
            rowTitle: [{ type: core.Input }],
            data: [{ type: core.Input }],
            enableItemCLick: [{ type: core.Input }],
    ...
    var WizardStepComponent = /** @class */ (function () {
        function WizardStepComponent() {
            ...
            // tslint:disable-next-line:no-output-on-prefix
            this.onPrev = new core.EventEmitter();
            // tslint:disable-next-line:no-output-on-prefix
        ...
        WizardStepComponent.propDecorators = {
            ...
            isAllowed: [{ type: core.Input }],
            showNext: [{ type: core.Input }],
            showPrev: [{ type: core.Input }],
            onNext: [{ type: core.Output }],
            onPrev: [{ type: core.Output }],
            onComplete: [{ type: core.Output }],
            onCancel: [{ type: core.Output }],
            isActive: [{ type: core.Input, args: ['isActive',] }]
        };
    ...
    var WizardComponent = /** @class */ (function () {
        function WizardComponent() {
            ...
            // tslint:disable-next-line:no-output-on-prefix
            this.onStepChanged = new core.EventEmitter();
        }
        /**
         * @return {?}
         */
        ...
        WizardComponent.propDecorators = {
            wizardSteps: [{ type: core.ContentChildren, args: [WizardStepComponent,] }],
            cancelLbl: [{ type: core.Input }],
            previousLbl: [{ type: core.Input }],
            nextLbl: [{ type: core.Input }],
            doneLbl: [{ type: core.Input }],
            clickTabEnable: [{ type: core.Input }],
            forceStep: [{ type: core.Input }],
            formSubmitting: [{ type: core.Input }],
            pagingLabel: [{ type: core.Input }],
            wizardNextTrigger: [{ type: core.Input }],
            onStepChanged: [{ type: core.Output }]
        };
    ...
    var PhotoUploadComponent = /** @class */ (function () {
        ...
        PhotoUploadComponent.propDecorators = {
            tagar: [{ type: core.ViewChild, args: ['tagar',] }],
            label: [{ type: core.Input }],
            required: [{ type: core.Input }],
            fileType: [{ type: core.Input }],
            maxFileSize: [{ type: core.Input }],
    ...
    var ToastService = /** @class */ (function () {
        ...
        /** @nocollapse */ ToastService.ngInjectableDef = core.defineInjectable({ factory: function ToastService_Factory() { return new ToastService(core.inject(core.ComponentFactoryResolver)); }, token: ToastService, providedIn: "root" });
        return ToastService;
    }());
    if (false) {
        /**
    ...
    var TranslateService = /** @class */ (function () {
        ...
        function TranslateService(_translations) {
            ...
            this.PLACEHOLDER = '%';
            this.onLangChanged = new core.EventEmitter();
        }
    ...
    var TabsetDirective = /** @class */ (function () {
        ...
        TabsetDirective.propDecorators = {
            title: [{ type: core.Input }],
            tabIcon: [{ type: core.Input }],
            active: [{ type: core.HostBinding, args: ['class.tab-active',] }, { type: core.Input }],
            selectedTab: [{ type: core.Input }],
    ...
    var ToastDirective = /** @class */ (function () {
        ...
        ToastDirective.propDecorators = {
            timeOut: [{ type: core.Input, args: ['timeOut',] }],
            toastIndex: [{ type: core.Input, args: ['toastIndex',] }],
            removeOnClick: [{ type: core.Input, args: ['removeOnClick',] }],
            onClick: [{ type: core.HostListener, args: ['click',] }],
            onMouseHover: [{ type: core.HostListener, args: ['mouseover',] }],
    ...
    var CollapseDirective = /** @class */ (function () {
        ...
        CollapseDirective.propDecorators = {
            ...
            onTransitionEnd: [{ type: core.HostListener, args: ['transitionend',] }]
        };
        ...
        PilarModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        imports: [
                            ...
                            ngxLazyLoadImages.LazyLoadImagesModule,
                            ngxSelectEx.NgxSelectModule,
                            ...
                            ngxContextmenu.ContextMenuModule.forRoot(),
                        ...
                        exports: [
                            ...
                            ngxBootstrap.BsDatepickerModule,
    ...
    exports.IMAGES_ROOT = IMAGES_ROOT;
    ...
    exports.LoadingBarEventType = LoadingBarEventType;
    ...
    exports.PilarComponent = PilarComponent;
    exports.PilarModule = PilarModule;
    exports.PilarService = PilarService;
    exports.SwitchComponent = SwitchComponent;
    exports.TablePageService = TablePageService;
    exports.TableSkeletonComponent = TableSkeletonComponent;
    exports.TabsetComponent = TabsetComponent;
    exports.TabsetDirective = TabsetDirective;
    exports.TextEditorComponent = TextEditorComponent;
    exports.ToastComponent = ToastComponent;
    exports.ToastDirective = ToastDirective;
    exports.ToastService = ToastService;
    exports.TranslatePipe = TranslatePipe;
    exports.TranslateService = TranslateService;
    exports.UiiDataGridComponent = UiiDataGridComponent;
    exports.UiiImageUploadComponent = UiiImageUploadComponent;
    ...
    exports.ɵb = ClientTableComponent;
    exports.ɵc = TablePageService;
    exports.ɵd = FileUploadComponent;
    exports.ɵe = MobileFilterComponent;
    exports.ɵf = ServerTableComponent;
    exports.ɵg = ImageService;
    exports.ɵh = TableComponent;
    exports.ɵi = TableActionComponent;
    exports.ɵj = TableFilterComponent;
    exports.ɵk = TableFooterComponent;
    exports.ɵl = ToastService;
    exports.ɵm = TranslateService;
    exports.ɵn = TRANSLATIONS;
    exports.ɵo = dictionary;
    exports.ɵp = CollapseDirective;
    exports.ɵq = LANG_EN_TRANS;
    exports.ɵr = LANG_ID_TRANS;
    exports.ɵs = LoadingBarService;
    exports.ɵt = ConfigService;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=pilar.umd.js.map
